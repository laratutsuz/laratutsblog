          ...
          <div class="row g-5">
            <div class="col-lg-4">
              <div class="post-entry-1 lg">
                <a href="{{ route("post.show", ['id'=>$post->id]) }}"><img src="{{ asset("images/".$post->image) }}" alt="" class="img-fluid"></a>
                <div class="post-meta"><span class="date">{{ $post->name }}</span> <span class="mx-1">&bullet;</span> <span>{{ date("d.m.Y", strtotime($post->created_at)) }}</span></div>
            ...
            <div class="col-lg-8">
              <div class="row g-5">
                <div class="col-lg-4 border-start custom-border">
                    @foreach ($randomPostsOne as $item)
                    <div class="post-entry-1">
                        <a href="{{ route("post.show", ['id'=>$item->id]) }}"><img src="{{ asset("images/".$item->image) }}" alt="" style="height: 200px!important;" class="img-fluid"></a>
                ...
                <div class="col-lg-4 border-start custom-border">
                    @foreach ($randomPostsTwo as $item)
                    <div class="post-entry-1">
                        <a href="{{ route("post.show", ['id'=>$item->id]) }}"><img src="{{ asset("images/".$item->image) }}" alt="" style="height: 200px!important;" class="img-fluid"></a>
                        <div class="post-meta"><span class="date">{{ $item->name }}</span> <span class="mx-1">&bullet;</span> <span>{{ date("m.d.Y", strtotime($item->created_at)) }}</span></div>
                        <h2><a href="{{ route("post.show", ['id'=>$item->id]) }}">{{ $item->title }}</a></h2>
